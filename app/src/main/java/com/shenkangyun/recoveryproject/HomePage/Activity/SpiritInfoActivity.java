...
public class SpiritInfoActivity extends AppCompatActivity {
    ...
    private String policy = "免鉴定费80元；持证的精神病患者，符合服药条件，经过审批后，到泰安市复退军人精神病院享受400元药品补助。";
    private String[] tel = new String[]{"5361329"};
    private String[] name = new String[]{"泰安市复退军人精神病院"};
    private String[] scope = new String[]{"精神疾病的诊断治疗，心理咨询，康复"};
    private String[] contacts = new String[]{"赵燕"};
