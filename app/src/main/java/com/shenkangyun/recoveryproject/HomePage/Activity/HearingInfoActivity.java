...
public class HearingInfoActivity extends AppCompatActivity {
    ...
    private Double[] yAxis = new Double[]{36.190457};
    private Double[] xAxis = new Double[]{117.141156};

    private String policy = "免鉴定费80元;对年龄在0—6岁的重度听力（双裸耳听力损失≥100分贝）残疾儿童，经评估符合植入电子耳蜗条件的，免费为其提供人工耳蜗产品1套；手术费用按每人12000元补助，用于术前复筛检查、手术及术后5次调机；按每人14000元标准对术后一学年（10个月）的康复训练给予补助，主要用于术后康复训练、康复评估、家长培训、康复教材等。";
    private String[] name = new String[]{"泰安市中医二院"};
    private String[] tel = new String[]{"05388519676"};
    private String[] scope = new String[]{"负责听力残疾人的残疾评定以及评定后残疾人精准康复服务。"};
    private String[] contacts = new String[]{"张元宁"};
