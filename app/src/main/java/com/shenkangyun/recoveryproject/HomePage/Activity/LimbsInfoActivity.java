...
public class LimbsInfoActivity extends AppCompatActivity {
    ...
    private Double[] yAxis = new Double[]{36.190457, 36.18931, 36.197475};
    private Double[] xAxis = new Double[]{117.141156, 117.083713, 117.139116};

    private String policy = "有康复需求的肢体残疾人，每人享受补贴300元。";
    private String[] name = new String[]{"泰安市中医二院", "泰山医学院附属医院", "泰山区人民医院"};
    private String[] tel = new String[]{"6112509", "13953801456", "13953816355"};
    private String scope = "负责肢体残疾人的残疾评估以及评估后残疾人精准康复服务。";
    private String[] contacts = new String[]{"丁明乾", "王瑞臣", "贾宁"};
    ...
    private void initData() {
        ...
        switch (id) {
            case 0:
                ...
                tvScope.setText("负责肢体残疾人的残疾评定以及评定后残疾人精准康复服务。");
                tvPolicy.setText("免鉴定费80元；有康复需求的肢体残疾人，每人享受补贴300元。");
